...
\usepackage{appendix} %Anhang-Paket


%\usepackage{fancyhdr}
% Hier kann der Seitentitel (Im Header) angepasst werden Even/Odd und Right/Left
...
% Anhang (Seitenränder vorher verringern)
\newgeometry{left=35mm,right=35mm,top=5mm,bottom=5mm, includeheadfoot}
% Auswirkungen von let\clearpage\... bleiben innerhalb der Gruppe
\begingroup
\appendix
\addappheadtotoc
